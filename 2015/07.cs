...
namespace advent._2015
{
    ...
    {
        private readonly IDictionary<string, ushort?> _wires = new Dictionary<string, ushort?>();
        private readonly IDictionary<string, Instruction> _instructions = ParseInstructions(INPUT);
